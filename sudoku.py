...
class Sudoku:
    ...
    def options_at(self, x: int, y: int) -> Iterable[int]:
        ...
        return self.options_at_row(y) & self.options_at_column(x) & self.options_at_block(x, y)
    ...
    def options_at_row(self, y: int) -> Iterable[int]:
        options = [1, 2, 3, 4, 5, 6, 7, 8, 9]
        return set(options) - set(self.row_values(y))
    ...
    def options_at_column(self, x: int) -> Iterable[int]:
        options = [1, 2, 3, 4, 5, 6, 7, 8, 9]
        return set(options) - set(self.column_values(x))
    ...
    def options_at_block(self, x: int, y: int) -> Iterable[int]:
        options = [1, 2, 3, 4, 5, 6, 7, 8, 9]
        block_index = (y // 3) * 3 + x // 3
        return set(options) - set(self.block_values(block_index))
    ...
    def is_solved(self) -> bool:
        ...
        """
        for i in range(9):
            if 0 in self.column_values(i) or 0 in self.row_values(i) or 0 in self.block_values(i):
                return False
        return True
